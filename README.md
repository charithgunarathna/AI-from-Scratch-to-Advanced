...
graph TD
    A[Module 01: Math & Python Foundations] --> B(Module 02: Machine Learning)
    B --> C(Module 03: Deep Learning & CNNs)
    C --> D(Module 04: NLP & LLMs)
    D --> E(Module 05: Generative AI & MLOps)
    
    style A fill:#2b2d42,stroke:#edf2f4,stroke-width:2px,color:#ffffff
    style B fill:#8d99ae,stroke:#edf2f4,stroke-width:1px,color:#ffffff
    style C fill:#ef233c,stroke:#edf2f4,stroke-width:1px,color:#ffffff
    style D fill:#d90429,stroke:#edf2f4,stroke-width:1px,color:#ffffff
    style E fill:#2a9d8f,stroke:#edf2f4,stroke-width:1px,color:#ffffff
```
